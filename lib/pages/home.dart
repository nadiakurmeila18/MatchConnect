      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            child: Align(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.pushNamed(context, '/profilpage'); // Ganti dengan rute yang sesuai
                },
                child: Image.asset(
                  ("assets/p1.png"),
                ),
        ...
        Padding(
            ...
            child: Align(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.pushNamed(context, '/moviePage'); // Ganti dengan rute yang sesuai
                },
                child: Text(
                  "Movie",
                  style: TextStyle(
          ...
          SingleChildScrollView(
           ...
           Padding(
            ...
            child: Align(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.pushNamed(context, '/theaterPage'); // Ganti dengan rute yang sesuai
                },
                child: Text(
                  "Theater",
                  style: TextStyle(
